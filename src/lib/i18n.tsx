...
const translations: Record<Language, Translations> = {
  ...
  es: {
    "app.name": "INAGROSOLUTIONS",
    "app.tagline": "GestiÃ³n profesional de micro-aplicaciones SaaS",
    "login.hero_title": "Tu Cuaderno de Campo de GestiÃ³n Digital",
    ...
    "login.signup": "Â¿No tienes cuenta? RegÃ­strate",
    "signup.title": "Crear Cuenta",
    "signup.firstName": "Nombre",
    "signup.lastName": "Apellido",
    "signup.submit": "Crear Cuenta",
    "signup.login": "Â¿Ya tienes cuenta? Inicia sesiÃ³n",
    "signup.success": "Â¡Cuenta creada! Revisa tu correo para verificarla.",
    "forgot.title": "Restablecer ContraseÃ±a",
    "forgot.submit": "Enviar enlace de recuperaciÃ³n",
    "forgot.back": "â† Volver a iniciar sesiÃ³n",
    "forgot.success": "Enlace de recuperaciÃ³n enviado. Revisa tu correo.",
    "welcome.title": "Â¡Bienvenido a INAGROSOLUTIONS!",
    "welcome.subtitle": "Estamos preparando algo increÃ­ble para ti.",
    "welcome.badge": "PrÃ³ximamente",
    "welcome.hello": "Hola, {name} ðŸ‘‹",
    "welcome.footer": "Te notificaremos cuando todo estÃ© listo.",
    "welcome.logout": "Cerrar SesiÃ³n",
    "toast.verified": "Â¡Email Confirmado! Tu cuenta ha sido verificada.",
    "toast.error": "OcurriÃ³ un error.",
    "toast.authlinkfailed": "El enlace de autenticaciÃ³n fallÃ³ o expirÃ³.",
    "dashboard.microApps": "Micro Apps",
    "dashboard.app1": "Micro App #1",
    "dashboard.search": "Buscar... âŒ˜K",
    ...
    "dashboard.action1": "Nueva CampaÃ±a",
    "dashboard.action2": "Generar Reporte",
    "dashboard.action3": "Ajustes del Sistema",
    "dashboard.recentActivity": "Actividad Reciente",
    "dashboard.activity1": "El usuario Sarah se registrÃ³",
    ...
    "gdpr.accept": "Acepto la PolÃ­tica de Privacidad",
    "gdpr.privacyPolicy": "PolÃ­tica de Privacidad",
    "gdpr.cookiePolicy": "PolÃ­tica de Cookies",
    "gdpr.legalNotice": "Aviso Legal",
    "cookies.title": "Usamos cookies",
    "cookies.description": "Utilizamos cookies para mejorar tu experiencia y analizar el trÃ¡fico. Al continuar navegando, aceptas nuestro uso de cookies.",
    "cookies.accept": "Aceptar todas",
    "cookies.settings": "ConfiguraciÃ³n",
    "legal.title": "InformaciÃ³n Legal",
